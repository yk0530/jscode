      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cartInfo in cartInfoList" :key="cartInfo.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cartInfo.isChecked" @click="UpdateChecked(cartInfo,$event)">
          </li>
          ...
          <li class="cart-list-con5" >
            ...
            <input autocomplete="off" type="text" :value="cartInfo.skuNum" minnum="1" class="itxt" @change="handler('change',parseInt($event.target.value * 1) - cartInfo.skuNum,cartInfo)">
